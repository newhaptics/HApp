...
class DisplaySerial(serial.Serial):
    ...
    def getSize(self):
        self.nRows = 0# self.getNRows()
        self.nColumns = 0# self.getNColumns()
        self.nBytesPerRow = 0# self.getNBytesPerRow()
        self.nBytesPerColumn = 0# self.getNBytesPerColumn()
    ...
    # Touch related commands

    # Function 50: gets the touch gesture which has occured
    def getTouchGesture(self):
        self.write(bytearray([50]))
